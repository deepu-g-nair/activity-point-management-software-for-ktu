...
if(isset($_POST['addmrk']))
{
    ...
    if(move_uploaded_file($_FILES['up']['tmp_name'], getcwd()."\\../staff\\cert\\$fn"))
    {
    $ins_mrk=mysqli_query($dbcon,"INSERT INTO `student_point_temp`(`rol_num`, `subcatid`, `level_id`, `mark`, `mark_typ`, `mark_id`, `docfile`, `year`, `st`) VALUES ('$uid','$scat','$sublevelid','$mrk','1','$mrk_id','$fn','$yr','0')");
    if($ins_mrk>0)
    {
        header("location:index.php");
    }
...
if(isset($_POST['xmark']))
{
    ...
    $up=$_FILES['xup']['name'];
    $fn=time().uniqid(rand()).substr($up,strrpos($up,"."));
    $ins_mrk=mysqli_query($dbcon,"INSERT INTO `student_point_temp`(`rol_num`, `subcatid`, `level_id`, `mark`, `mark_typ`, `mark_id`, `docfile`, `year`, `st`) VALUES ('$uid','$scat','$sublevelid','$mrk','2','$mrk_id','$fn','$yr','0')");
    if($ins_mrk>0)
    {
        header("location:index.php");
    }
                                                        ...
                                                        ?>
                                                            ...
                                                            <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    ?>
                                                                    <td style="width: 15%;"><a class="label label-primary" href="index.php?sid=<?php echo encrypt_url($r6[0]) ?>"><span class="fa fa-arrow-circle-o-right" style="color: yellow;"></span>  More</a></td>
