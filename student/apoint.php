...
{
    $uid=$_SESSION['stud'];    
    $sel_data=mysqli_query($dbcon,"select * from student_data where rol_num='$uid'");
    $rdata=mysqli_fetch_row($sel_data);
    $cid=$rdata[1];
    $did=$rdata[2];
    $sem=$rdata[3];
    $ay=$rdata[4];
    $sel_crs=mysqli_query($dbcon,"select * from course_data where crsid='$cid'");
    $rcrs=mysqli_fetch_row($sel_crs);
    $sel_dep=mysqli_query($dbcon,"select * from dep_data where depid='$did'");
					...
					<ul class="nav ace-nav">
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
                                                            <img class="nav-user-photo" src="../staff/studpic/<?php echo $rdata[14] ?>" alt=""/>
						...
						<div class="row">
                                                    ...
                                                    <div class="row">                                                        
                                                        <div class="col-md-6">
                                                            <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                                                <tr>
                                                                    <td style="width: 50%;">
                                                                        <img src="../staff/studpic/<?php echo $rst[14] ?>" alt="<?php echo $rst[5] ?>" class="img img-responsive img-thumbnail" /> 
                                                                    </td>
                                                                    <td>
                                                        ...
                                                        <div class="col-md-6">
                                                            <?php
                                                            $selp=mysqli_query($dbcon,"select * from student_point where rol_num='$uid'");
                                                            if(mysqli_num_rows($selp)>0)
                                                            {
                                                                ?>
                                                            <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                                                <tr>
                                                                    <td colspan="2"><b><center>AVAILABLE POINTS</center></b></td>
                                                                </tr>
                                                                <?php
                                                    ...
                                                    <div class="container">
                                                         ...
                                                         while($rcat=mysqli_fetch_row($sel_cat))
                                                        {
                                                           ?>
                                                            <tr>
                                                                <td colspan="5"><?php echo $rcat[1] ?></td>                                                                
                                                            </tr>
                                                            <?php
                                                            ...
                                                            if(mysqli_num_rows($selsub)>0)
                                                            {
                                                                ...
                                                                {
                                                                    $subid=$rsub[0];
                                                                    $data1=mysqli_query($dbcon,"select * from student_point_temp where subcatid='$subid' and rol_num='$uid'");
