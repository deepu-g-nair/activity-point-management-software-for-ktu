...
if(isset($_POST['sub']))
{
    ...
    if(mysqli_num_rows($chk)>0)
    {
        ...
        header("location:apoint.php?rn=$rn");
    }
    else
    {
        header("location:apoint.php?error=1");
    }
}
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">                                                    
                                                    <a href="apointclass.php" class="label label-danger pull-right">VIEW CLASS WISE DETAILS</a>
                                                    <div class="col-xs-12">
