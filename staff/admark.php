...
if(isset($_POST['sub']))
{
    ...
    for($i=1;$i<=$count;$i++)
    {
        $mrk=$_POST["m$i"];
        $lvl=$_POST["n$i"];
        $ins=mysqli_query($dbcon,"INSERT INTO `subcat_xmrk`(`subid`, `mrk_base`, `descr`, `mrk`, `lvlid`) VALUES ('$sid','$mb','$des','$mrk','$lvl')");
    }
    if($ins>0)
    {
        header("location:admark.php?sid=".encrypt_url($sid));
    }
}
?>
<!DOCTYPE html>
					...
					<div class="page-content">
						...
						<div class="row">
                                                    <div class="col-xs-12">
                                                        ...
                                                        {
                                                            $sid=  decrypt_url($_GET['sid']);
                                                            $selsub=mysqli_query($dbcon,"select * from subcategory_data where subid='$sid'");
                                                            $rsub1=mysqli_fetch_row($selsub);
                                                            $lid=$rsub1[3];
                                                            ?>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                                                    <tr>
                                                                        <td colspan="2"><center><b><?php echo $rsub1[2] ?></b></center></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Mark Base</td>
                                                                        <td><input type="text" name="mb" class="form-control" required="required" /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Description</td>
                                                                    ...
                                                                    <?php
                                                                    $sel_lvl=mysqli_query($dbcon,"select * from sublevel_settings where lid='$lid'");
                                                                    $i=0;
                                                                    while($rl1=mysqli_fetch_row($sel_lvl))
                                                                    {
                                                                        $i++;
                                                                        ?>
                                                                    <tr>
                                                                        <td><?php echo $rl1[2] ?></td>
                                                                        <td><input placeholder="mark here..." type="text" name="m<?php echo $i ?>" class="form-control" required="required" />
                                                                        <input type="hidden" value="<?php echo $rl1[0] ?>" name="n<?php echo $i ?>"  class="form-control" required="required" />
                                                                        </td>
                                                                    </tr>
                                                                    <?php
                                                                    }                                                                    
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="2">
                                                                    <center>
                                                                        <input type="hidden" value="<?php echo $i ?>" name="count"  class="form-control" required="required" />
                                                                        <input type="submit" name="sub" value="ADD NOW" class="btn btn-success btn-sm" />
                                                                    </center>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <div class="col-md-6">
                                                                <?php 
                                                                $selxm=mysqli_query($dbcon,"select distinct (mrk_base) from subcat_xmrk where subid='$sid'");
                                                                if(mysqli_num_rows($selxm)>0)
                                                                {
                                                                    ?>
                                                                <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                                                    <tr>
                                                                    ...
                                                                    <?php
                                                                    $z=0;
                                                                    while($rx=mysqli_fetch_row($selxm))
                                                                    {
                                                                        $z++;
                                                                        ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <?php
                                                                            $selxm1=mysqli_query($dbcon,"select * from subcat_xmrk where mrk_base='$rx[0]' and subid='$sid'");
                                                                            $rx1=mysqli_fetch_row($selxm1);
                                                                            ?>
                                                                            <b><?php echo $rx1[2] ?></b><br /><?php echo $rx1[3] ?></td>
                                                                        <td>
                                                                        <?php
                                                                        $selxm2=mysqli_query($dbcon,"select * from subcat_xmrk where mrk_base='$rx[0]' and subid='$sid'");
                                                                        while($rx2=mysqli_fetch_row($selxm2))
                                                                        {
                                                                            echo $rx2[4]."<br />"; 
                                                                        }
                                                                        ?>
                                                            ...
                                                            <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 5%;"><center>
                                                                        ...
                                                                        {
                                                                            ?>
                                                                        <a href="admark.php?sid=<?php echo encrypt_url($r6[0]) ?>"><span class="fa fa-plus-circle" style="color: #006dcc;"></span></a>
                                                                        <?php
                                                                        }
                                                                        else{
                                                                            ?>
                                                                        <span class="fa fa-minus-circle" style="color: #c6c6c6;"></span>
                                                                        <?php
                                                                        }
                                                                        ?></center>
                                                                    </td>
