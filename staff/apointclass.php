...
if(isset($_POST['sub']))
{
    ...
    header("location:apointclass.php?c=$c&d=$d&ay=$ay");
}
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Class wise Activity Point
								</small>
							</h1>
						</div><!-- /.page-header -->

						<div class="row">                                                    
                                                    <a href="apoint.php" class="label label-danger pull-right">VIEW STUDENT WISE DETAILS</a>
                                                    <div class="col-xs-12">
                                                        <div class="col-md-3"></div>
                                                        <div class="col-md-6"><form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                                            <tr>
                                                                <td colspan="6">
                                                            <center><b>Total Students : <?php echo $msg ?> Batch</b></center>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>#</td>
                                                            ...
                                                            <tr>
                                                                <td><?php echo $i ?></td>
                                                                <td><?php echo $rstud[5] ?></td>
                                                                <td><?php echo $rstud[6] ?></td>
                                                                <td>
                                                                    <?php
                                                                    $selpoint=mysqli_query($dbcon,"select sum(mark) from student_point where rol_num='$rstud[6]'");
                                                                    $rp=mysqli_fetch_row($selpoint);
                                                                    echo $rp[0];
                                                                    ?>
                                                                </td>
                                                            </tr>
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                                            <tr>
                                                                <td colspan="6">
                                                            <center><b>Students with Mark <span class="label label-danger">less than 100</span>  : <?php echo $msg ?> Batch</b></center>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>#</td>
