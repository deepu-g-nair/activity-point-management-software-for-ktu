...
if(isset($_POST['sub']))
{
    ...
    if($_FILES['up']['name'])
    {
        ...
        {
            $insstf=mysqli_query($dbcon,"INSERT INTO `staff_data`(`nme`, `stfid`, `em`, `con`, `gndr`, `addr`, `cid`, `did`, `pic`, `dstatus`, `st`) VALUES ('$sn','$sid','$em','$con','$gn','$addr','$cid','$did','$nfn','1','1')");
        }
    }
    else
    {
    ...
    if($insstf>0)
    {
        $inslog=mysqli_query($dbcon,"INSERT INTO `user_login`(`uid`, `pas`, `typ`, `st`) VALUES ('$sid','$pas','staff','1')");
        if($inslog>0)
        {
            header("location:add-staff.php?suc=1");
        }
    }
}
?>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" name="con" pattern="[789][0-9]{9}" maxlength="10" class="form-control" required="required" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Gender</td>
                                                            ...
                                                            <tr>
                                                                <td colspan="2"><center>                                                                
                                                                    <input type="submit" name="sub" value="ADD STAFF" class="btn btn-success btn-sm" />
                                                            </center>
                                                                </td>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            function loadname(x)
                                                            {
                                                                var xmlhttp = new XMLHttpRequest();
                                                                    ...
                                                                    xmlhttp.open("GET", "loadstaff.php?q=" + x, true);
                                                                    xmlhttp.send();
                                                            }
                                                            </script>
                                                            <?php
                                                            ...
                                                            {
                                                                ?>
                                                            <input type="text" class="form-control" style="margin-bottom: 5px;" placeholder="Search By Name..." onkeyup="loadname(this.value)" />
                                                            <div id="resultdata">
                                                            <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                                                <tr>
                                                                    <td>#</td>
